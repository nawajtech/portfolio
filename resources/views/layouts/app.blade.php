...
<head>
    ...
    <meta name="description" content="Nawaj Sharif - Engineering Team Lead. Leading delivery, backend systems, and scalable APIs.">
    <title>@yield('title', 'Nawaj Sharif | Engineering Team Lead')</title>
