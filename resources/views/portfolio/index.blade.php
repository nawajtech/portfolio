...
<nav class="nav-header" role="banner">
    <div class="nav-logo">
        <a href="#home" class="nav-logo-link" aria-label="Nawaj Sharif - Home">
            ...
            @else
                <span class="nav-logo-text">NawjS</span>
            @endif
        </a>
    </div>
    <ul class="nav-links">
...
<section class="hero" id="home">
    <h1 class="hero-anim hero-anim-1">Hi, Welcome to my profile 👋<br>I'm Nawaj <span>Sharif</span></h1>
    <h3 class="hero-anim hero-anim-2">Senior Software Developer</h3>
    <p class="hero-anim hero-anim-3">
        I build scalable web applications, powerful APIs, and modern backend systems. 
